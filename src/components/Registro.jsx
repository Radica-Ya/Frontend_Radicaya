...
const Formulario = () => {
    const  { register, handleSubmit, formState: {errors}, watch } = useForm()
        console.log(errors)
// El watch es para obtener los valores de los imput y asi hacer la 
//logica del confirmarcontrasena    
   ...
   return <div className="container" >
        ...
        <form className="form" onSubmit={onSubmit}>
                ...
                {...register("telefono", {
                    ...
                    pattern: {
                        value: /^\d+$/,
                        message: "Solo se Permiten Caracteres de Tipo Númerico "
                    },
                    minLength: {
                        value: 7,
        ...
        <Link to="/login" className="Link">Ir a la página de inicio de sesión.</Link>
    </div>
}
